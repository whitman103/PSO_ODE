...
class Particle{
	public:
	Particle(vector<vector<hillStruct> > inSolution, tuple<double,double,double,double> bounds);
	~Particle();
    ...
    vector<vector<double> > powerCurrentPos;
    vector<vector<double> > powerBestPos;
    vector<vector<double> > powerVelocity;
